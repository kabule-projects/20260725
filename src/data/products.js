export const PRODUCTS = [
  {
    ...
    title: "我的勇气",
    branch: "[？]",
    description: "看起来很轻盈的日记本，总会有新的一页供你书写。\n无法被测重，价值不可估量。",
  ...
  },
  {
    ...
    title: "安静的翅膀",
    branch: "[占位文本]",
    description: "通体蓝色，晴雨两用。\n似乎没有安装伞骨，但据说足以承载一个年轻孩子的重量。",
  ...
  },
  {
    ...
    title: "想去的地方",
    branch: "[占位文本]",
    description: "一种神奇的自动感应钥匙，不需要插进锁孔。\n能够打开属于你的地方、你向往的地方，还有你心灵的归处。",
  ...
  },
  {
    ...
    title: "定制护深服",
    branch: "[占位文本]",
    description: "百年间只为一名顾客量身定做，且包售后服务。\n正是他们之间特殊的纽带成就了这件商品。",
    image: '/images/2021.jpg',
    showcaseImage: '/images/2021.webp',
    gameType: "quiz",
    locked: false,
    moreInfo: {
  ...
  },
  {
    ...
    title: "旅人的馈赠",
    branch: "[占位文本]",
    description: "世上怎么可能有不求回报的期待？试着养育一朵花，你就会明白的。\n你不知道它会开出什么，是否会开花。\n你只是很爱它。",
  ...
  },
  {
    ...
    title: "真实的色彩",
    branch: "[占位文本]",
    description: "里面盛满了白色油漆，不同的人能刷出不同的色彩。\n很神奇吧？就像白水也可以有辛辣之味。",
  ...
  },
  {
    ...
    title: "世界之窗",
    branch: "[占位文本]",
    description: "拥有它，你可以解锁一扇空中的窗子。\n透过这窗子虽看不满世界，却可以让整个世界都看到你。",
  ...
  },
  {
    ...
    title: "永远同行之人",
    branch: "[占位文本]",
    description: "由神秘顾客提供的、本店最有价值的物品之一。\n不具有流通性，因此只接受时间支付。",
  ...
  },
  {
    ...
    gameType: "whack",
    videoUrl: "https://player.bilibili.com/player.html?bvid=BV11RKV6eETs&page=1&autoplay=1&high_quality=1&danmaku=1",
    locked: true,
    moreInfo: {
